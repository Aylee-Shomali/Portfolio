...
export function HomeContact() {
  return (
    <section id="contact" className="scroll-mt-20 bg-surface-dark text-canvas">
        ...
        <FadeIn delay={0.1}>
          <div className="mt-10 flex flex-col sm:flex-row gap-6">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-6 py-4 rounded-full border-2 border-cyan text-cyan font-mono text-sm hover:bg-cyan hover:text-canvas transition-colors"
            >
